...
_ARGS = "testflows.github.runners.args"
_PROVIDERS = "testflows.github.runners.providers"
...
def guard_detects_a_planted_violation(self):
    ...
    tree = ast.parse(src)
    targets = _targets("testflows.github.runners.providers.hetzner.provider", tree)
